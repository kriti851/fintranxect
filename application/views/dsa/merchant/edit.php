                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-row mt-4">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <input class="multisteps-form__input form-control" id="first_name" title="First Name" type="text" value="<?php echo $exp[0]; ?>" placeholder="First Name"/>
                                            </div>
                                            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                                <small class="text-danger" id="last_name_error"></small>
                                                <input class="multisteps-form__input form-control" id="last_name" title="Last Name" type="text" value="<?php echo end($exp) ?>" placeholder="Last Name"/>
                                            </div>
                                        </div>
                                        <div class="form-row mt-4">
                                            <div class="col-12 col-sm-6">
                                                <small class="text-danger" id="email_error"></small>
                                                <input class="multisteps-form__input form-control" id="email" title="Email" type="email" value="<?php echo $users->email; ?>" placeholder="Email"/>
                                            </div>
                                            <div class="col-12 col-sm-6  mt-4 mt-sm-0">
                                                <small class="text-danger" id="phone_error"></small>
                                                <input class="multisteps-form__input form-control" id="phone" title="Mobile Number" maxlength="10" disabled type="text" value="<?php echo $users->mobile_number; ?>" placeholder="Mobile number"/>
                                            </div>
                                        </div>
                                        <div class="form-row mt-4">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <select class="multisteps-form__input form-control" title="Type Of Occupation" id="employment_type">
                                                    ...
                                                    <option value="Salaried" <?php if(!empty($users->loan_type) && $users->loan_type=='Salaried'){ echo "selected"; }elseif(!empty($detail->employment_type) && $detail->employment_type=='Saleried'){ echo "selected"; } ?>>Salaried</option>
                                                    <option value="Business" <?php if(!empty($users->loan_type) && $users->loan_type=='Business'){ echo "selected"; }elseif(!empty($detail->employment_type) && $detail->employment_type=='Business'){ echo "selected"; } ?>>Business</option>
                                                </select>
                                            </div>
                                            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                                <small class="text-danger" id="age_error"></small>
                                                <input class="multisteps-form__input form-control" title="Age" id="age" value="<?php echo $users->age; ?>" type="number" placeholder="Age"/>
                                            </div>
                                        </div>
