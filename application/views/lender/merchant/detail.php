                    ...
                    <div class="row">
                    	...
                    	<h3 class="text-left">Personal Detail
							<div class="float-right">
								<div class="buttons">
									<h5>
									<a href="<?php echo lender_url('merchant/DownloadApplicant/'.$record->user_id); ?>" download class="button viewbutton"><i class="fa fa-download"></i> Download Case</a>
						...
						<div class="information">
							...
							<?php if(!empty($record->resident_address)){  ?>
								<div style="width:100%" class="quote-imgs-thumbs">
									...
									<?php $imagearray=explode(',',$record->resident_address_proof); foreach($imagearray as $file){ ?>
										<?php if(pathinfo($file,PATHINFO_EXTENSION) == 'pdf'){ ?>
