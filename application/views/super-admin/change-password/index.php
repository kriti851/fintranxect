                            ...
                            <form action="" method="post">
                                <div class="form-row">
                                    <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                        ...
                                        <input class="multisteps-form__input form-control" type="password" name="old_password" title="Old Password"  value="<?php echo set_value('old_password'); ?>" placeholder="Old Password"  />
                                    </div>
...
<script>
    document.getElementById('change-password-li').classList.add("active")
</script>