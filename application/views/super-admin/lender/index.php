    ...
    <div class="container top-full-width">
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                <h2>Lender Report Detail</h2>
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li class="active"><a href="#!">Lender Reports Detail</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="dashboard-section user-statistic-block">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                <div class="user-statistic">
                                    <h3><?php echo $mtd_lender; ?></h3>
                                    <span>MTD Lenders</span>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                <div class="user-statistic">
                                    <h3><?php echo $ytd_lender; ?></h3>
                                    <span>YTD Lenders</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                            ...
                            <div class="job-list">
                                <div class="body">
                                    <div class="content">
                                        ...
                                        <h4><a style="color:#007bff"><?php echo $result->company_name; ?></a></h4>
                                        <div class="info">
                                            <span class="company">
                                    ...
                                    <div class="more">
                                        <div class="buttons">
                                        <?php if(SubPermission(15)){ ?>
                                            <a href="javascript:void(0)" onclick="GetUserDetail(`<?php echo $result->user_id; ?>`)" class="button viewbutton" ><i class="far fa-eye"></i> View Profile</a>
                                        <?php } ?>
                                        <?php if(SubPermission(16)){ ?>
                                            <a href="<?php echo base_url('super-admin/lender/associate_merchants/'.$result->user_id); ?>" class="button viewbutton" ><i class="fa fa-user-plus"></i>View Cases</a>
                                        <?php } ?>
...
<div class="modal fade" id="viewdetail" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="lender_user_detail">
                
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <div id="button_lender">
