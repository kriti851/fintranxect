        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8 col-sm-7 col-12 mb30">
                ...
                <div class="dashboard-box-right">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="text-left">Notification
                                <div class="float-right">
                                    <div class="buttons">
                                        <h5>
                                            <?php if(SubPermission(51)){ ?>
                                                <a href="<?php  echo admin_url('log/ExportLog'); ?>" class="button viewbutton"><i class="fa fa-download"></i> Download</a>
                                            <?php } ?>
                                        </h5>
                                    </div>
                                </div>
                            ...
                            <div class="job-list">
                                ...
                                <div class="body">
                                    <div class="info" <?php if(SubPermission(49)){ ?> onclick="RedirectU(`<?php echo admin_url('merchant/detail/'.$result->merchant_id); ?>`)" <?php } ?>>
                                        <span class="company">
