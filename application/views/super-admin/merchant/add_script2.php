...
function UploadFile(){
    ...
    $.ajax({
        type: "POST",
        url: SiteUrl+"merchant/personalDocuments",
        data: formData,
        processData: false,
        contentType: false,
...
function getsuccess(){
    ...
    $.ajax({
        type: "POST",
        url: SiteUrl+"merchant/PersonalRegistration",
        data: formData,
        processData: false,
        contentType: false,
        beforeSend: function (request, xhr) {
...
function AutoSave(key,value){
    $.ajax({
        type: "POST",
        url: SiteUrl+"merchant/PersonalAutoSave",
        data: {
            'key':key,
            'value':value,
...
function OtherOrganization(value){
    if(value=='Other'){
        var html='<div class="md-input">'+
            ...
            '<label>Other organization</label>'+'<small class="text-danger invalid" id="other_organization_error"></small></div>';
