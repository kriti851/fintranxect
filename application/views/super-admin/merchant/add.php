                                            ...
                                            <?php if($detail->business_type=='Individual'){ ?>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/business/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="col-3 col-sm-3">
                                                            <div class="md-input">
                                                                <input class="md-form-control" <?php if(!empty($detail->bankstatement_password)){ echo $detail->bankstatement_password;} ?> id="bankstatement_password">
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/addition_docs/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/gst/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/ownership/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/partnership/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                                                    ...
                                                                                    <div class="m-2">
                                                                                        <a href="javascript:void(0)">
                                                                                            <img
                                                                                                ...
                                                                                                onclick="ShowLargeImage(this.src)"
                                                                                                id="<?php echo $randid; ?>"
                                                                                                src="<?php echo s3_url('uploads/merchant/other/'.$file); ?>"
                                                                                            />
                                                                                        </a>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/tan/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/coi/'.$file); ?>"
                                                                        />
                                                                    </a>
                                                                ...
                                                                <div class="m-2">
                                                                    <a href="javascript:void(0)">
                                                                        <img
                                                                            ...
                                                                            onclick="ShowLargeImage(this.src)"
                                                                            id="<?php echo $randid; ?>"
                                                                            src="<?php echo s3_url('uploads/merchant/boardresolution/'.$file); ?>"
                                                                        />
                                                                    </a>
