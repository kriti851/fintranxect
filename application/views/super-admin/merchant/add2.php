                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form id="msform">
                                <!-- progressbar -->
                                <ul id="progressbar">
                                    <li class="active">Additional Personal Info</li>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-12">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" value="<?php if(!empty($detail->father_name)){ echo $detail->father_name; } ?>" title="Father's Name" id="father_name" type="text" required="" />
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" oninput="this.value = Math.abs(this.value)" onkeyup="AutoSave(this.id,this.value)" title="Number of Kids" value="<?php if(!empty($detail->number_of_kids)){ echo $detail->number_of_kids; }elseif(!empty($detail)){ echo $detail->number_of_kids; } ?>" id="number_of_kids"  type="number" required="" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-12">
                                            <div class="md-input">
                                                <input class="md-form-control" id="employer_name" onkeyup="AutoSave(this.id,this.value)" type="text" value="<?php if(!empty($detail->employer_name)){ echo $detail->employer_name; }elseif(!empty($pay1data->shop_name)){ echo $pay1data->shop_name; } ?>" title="Name of current employer" required="" />
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-12 mt-4 mt-sm-0">
                                            <div class="md-input">
                                                <input class="md-form-control" id="designation" onkeyup="AutoSave(this.id,this.value)" type="text" value="<?php if(!empty($detail->designation)){ echo $detail->designation; } ?>" title="Designation" required="" />
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" id="organization" oninput="this.value = Math.abs(this.value)" onkeyup="AutoSave(this.id,this.value)" type="number" value="<?php if(!empty($detail->organization)){ echo $detail->organization; } ?>" title="No. of years in current organization" required="" />
                                    ...
                                    <div class="form-row mt-4">
                                        ...
                                        <div class="col-12 col-sm-6" id="filed_other_organization">
                                            <?php if(!empty($detail->organization_type) && $detail->organization_type=='Other'){ ?>
                                                <div class="md-input">
                                                    <input class="md-form-control" id="other_organization" onkeyup="AutoSave(this.id,this.value)" type="text" value="<?php if(!empty($detail->other_organization)){ echo $detail->other_organization; } ?>" title="Other organization" required="" />
                                    ...
                                    <div class="form-row mt-2">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" id="company_building" onkeyup="AutoSave(this.id,this.value)" value="<?php if(!empty($detail->company_building)){ echo $detail->company_building; } ?>"  type="text" title="Building No./Plot No." required="" />
                                        ...
                                        <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                            <div class="md-input">
                                                <input class="md-form-control" id="company_area" onkeyup="AutoSave(this.id,this.value)" value="<?php if(!empty($detail->company_area)){ echo $detail->company_area; } ?>" type="text" title="Locality/Area" required="" />
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" id="company_email" type="text" title="Official Email Address" value="<?php if(!empty($detail->company_email)){ echo $detail->company_email; } ?>" required="" />
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" id="company_website" type="text" title="Company Website" value="<?php if(!empty($detail->company_website)){ echo $detail->company_website; } ?>" required="" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" id="salery_inhand" type="number" value="<?php if(!empty($detail->salery_inhand)){ echo $detail->salery_inhand; } ?>" title="Monthly take home" required="" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row mt-2">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" id="residence_building" type="text" value="<?php if(!empty($detail->residence_building)){ echo $detail->residence_building; } ?>" title="Flat No./Building No./Street No." required="" />
                                        ...
                                        <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" id="residence_area" type="text" value="<?php if(!empty($detail->residence_area)){ echo $detail->residence_area; } ?>" title="Locality/Area" required="" />
                                                <label>Locality/Area</label>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" value="<?php if(!empty($detail->pan_number)){ echo $detail->pan_number; }elseif(!empty($pay1data->pan)){ echo $pay1data->pan; } ?>" type="text" id="pan_number" title="Enter PAN No." required="" />
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/pancard/'.$file); ?>"
                                                        />
                                                    </a>
                                    ...
                                    <div class="form-row mt-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="md-input">
                                                <input class="md-form-control" onkeyup="AutoSave(this.id,this.value)" type="text" value="<?php if(!empty($detail->aadhar_number)){ echo $detail->aadhar_number; } ?>" id="aadhar_number" title="Enter Aadhar No." required="" />
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            onclick="ShowLargeImage(this.src)"
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/aadharcard/'.$file); ?>"
                                                        />
                                                    </a>
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            onclick="ShowLargeImage(this.src)"
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/resident/'.$file); ?>"
                                                        />
                                                    </a>
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            onclick="ShowLargeImage(this.src)"
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/salery_slip/'.$file); ?>"
                                                        />
                                                    </a>
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            onclick="ShowLargeImage(this.src)"
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/bankstatement/'.$file); ?>"
                                                        />
                                                    </a>
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            onclick="ShowLargeImage(this.src)"
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/itr/'.$file); ?>"
                                                        />
                                                    </a>
                                                ...
                                                <div class="m-2">
                                                    <a href="javascript:void(0)">
                                                        <img
                                                            ...
                                                            onclick="ShowLargeImage(this.src)"
                                                            id="<?php echo $randid; ?>"
                                                            src="<?php echo s3_url('uploads/merchant/canceled_cheque/'.$file); ?>"
                                                        />
                                                    </a>
