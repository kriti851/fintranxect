            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="javascript:void(0)">City</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="col-sm-12">
                            <h3 class="text-left">
                                ...
                                <div class="float-right">
                                    <div class="buttons">
                                        <h5>
                                            <?php if(SubPermission(43)){ ?>
                                                <a href="<?php echo admin_url('setting/city/edit'); ?>"  class="button viewbutton" ><i class="fa fa-plus" aria-hidden="true"></i>Add New</a>
                                            <?php } ?>
                                        </h5>
                                    </div>
                                </div>
                            ...
                            <?php if(!empty($results)){  foreach($results as $result){  ?>
                                <div class="job-list">
                                    <div class="body">
                                        <div class="content">
                                            <span class="company">
                                            <?php echo $result->statename; ?>:<b><?php echo $result->name; ?> </b>
                                            </span>
                                    
                                        </div>
                                        <div class="more">
                                            <div class="buttons mr-2">
                                                <?php if(SubPermission(44)){ ?>
                                                    <a href="<?php echo admin_url('setting/city/edit/'.$result->id); ?>"  class="button viewbutton" ><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
