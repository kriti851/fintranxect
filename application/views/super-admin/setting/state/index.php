                                    ...
                                    <div class="buttons">
                                        <h5>
                                            <?php if(SubPermission(41)){ ?>
                                                <a href="javascript:void(0)" data-toggle="modal" data-target="#StateEdit" class="button viewbutton" ><i class="fa fa-plus" aria-hidden="true"></i>Add New</a>
                                            <?php } ?>
                                        </h5>
                                    </div>
                                </div>
                                            ...
                                            <div class="more">
                                                <div class="buttons mr-2">
                                                    <?php if(SubPermission(42)){ ?>
                                                        <a href="javascript:void(0)"  onclick="StateEdit(`<?= $row->id; ?>`,`<?= $row->name; ?>`)" class="button viewbutton" ><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>
...
<div class="modal fade" id="StateEdit" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="basicModal" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-body">
                    <div class="form-row mt-4">
                        ...
                        <div class="col-12 col-sm-12 mt-4 mt-sm-0">
                            <div class="md-input">
                                <input type="text" required class="md-form-control" id="statename" title="State">
                                <label>State</label>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="StateSubmit()" class="btn btn-primary">Submit</button>
