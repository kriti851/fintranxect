        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8 col-sm-7 col-12 mb30">
                ...
                <div class="dashboard-box-right">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="text-left">Login Log
                                <div class="float-right">
                                    <div class="buttons">
                                        <h5>
                                            <?php if(SubPermission(50)){ ?>
                                                <a href="<?php echo admin_url('loginlog/ExportLog'); ?>" class="button viewbutton"><i class="fa fa-download"></i> Download</a>
                                            <?php } ?>
                                        </h5>
                                    </div>
                                </div>
                            ...
                            <div class="job-list">
                                <div class="body">
                                    <div class="info">
                                        ...
                                        <span class="company">
                                            <a><b>Company: </b> <?php echo $result->company_name; ?></a>
                                        </span>
                                        <span class="company">
                                            <a><b>Login IP: </b> <?php echo $result->ip_address; ?></a>
                                        </span>
                                        <span class="company">
                                            <a><b>Login Time: </b> <?php echo date('d M Y h:i:A',strtotime($result->login_time)); ?></a>
                                        </span>
                                    </div>
                                </div>
                            </div>
...
<script>
    document.getElementById('loginlog-li').classList.add("active");
</script>
