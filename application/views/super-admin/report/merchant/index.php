...
<div class="modal fade" id="ExcelExportModal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo admin_url('excel/download_report'); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="form-row mt-4">
                        <div class="col-12 col-sm-12 mt-4 mt-sm-0">
                            <select name="filter_type" title="Loan Type" required class="multisteps-form__input form-control">
                    ...
                    <div class="form-row mt-4">
                        <div class="col-12 col-sm-12 mt-4 mt-sm-0">
                            <input type="text" name="rangepicker" value="<?php echo date('m/01/Y').' - '.date('m/t/Y'); ?>" required class="multisteps-form__input form-control" title="Date Range" placeholder="Date Range">
                        </div>
                    </div>
                    <div class="form-row mt-4">
                        <div class="col-12 col-sm-12 mt-4 mt-sm-0">
...
<script>
 ...
 document.getElementById("report-cases-li").classList.add("active");
</script>