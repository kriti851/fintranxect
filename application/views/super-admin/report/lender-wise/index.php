            ...
            <div class="col-xl-9 col-lg-9 col-md-8 col-sm-7 col-12 mb30">
                <div class="dashboard-box-right">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="text-left">
                                Lender Wise Report <?php if(!empty($total_rows)){ echo '('.$total_rows.')'; }else{ echo '(0)'; } ?>
...
<div class="modal fade" id="ExcelExportModal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo admin_url('lender_wise_report'); ?>" method="post">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Lender Wise Report</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row mt-4">
                        ...
                        <?php foreach($lenderlist as $lender){ ?>
                            <div class="col-md-6">
                                <div class="chiller_cb">
                                    <input class="checkbox_lender" id="select-<?php echo $lender->user_id; ?>" name="multi_id[]" value="<?php echo $lender->user_id; ?>" type="checkbox">
                                    <label for="select-<?php echo $lender->user_id; ?>"><span> <?php echo $lender->company_name ?></span></label>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
...
<script>
 ...
 document.getElementById("report-lenderwise-li").classList.add("active");
